...
**This site** is the human-readable showcase — who the characters are, which organisations they belong to, what happened when, pipeline deals and support cases, and the career and portfolio records that make them feel like real demo subjects. If you are looking for historical fact, you are in the wrong pub.
...
Browse **Personas**, **Organisations**, **Timeline**, **Deals**, and **Cases** from the links below, or read [Getting Started](/guides/getting-started/) to run the project locally.
